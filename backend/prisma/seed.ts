...
async function main() {
  ...
  const games = [
    ...
    },
    {
      title: 'FIFA 24',
      description:
        'The latest installment in the iconic football simulation series.',
      platform: Platform.PLAYSTATION,
      genre: 'Sports',
      price: 1990,
      imageUrl:
        'https://images.unsplash.com/photo-1493711662062-fa541f7f950b?w=400',
    },
    {
      title: 'Halo Infinite',
      description:
      ...
      price: 1590,
      imageUrl:
        'https://images.unsplash.com/photo-1552820728-8b83bb6b2b0c?w=400',
    },
    {
    ...
    },
    {
      ...
      description:
        'When a young street hustler, a retired bank robber and a terrifying psychopath find themselves entangled with some of the most frightening criminals in the underworld.',
      platform: Platform.STEAM,
      genre: 'Action',
      price: 699,
      imageUrl:
    ...
    },
    {
      ...
      price: 499,
      imageUrl:
        'https://images.unsplash.com/photo-1589241062272-c0a000072dfa?w=400',
    },
  ];
